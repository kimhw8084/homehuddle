  ...
  return (
    <Modal visible={visible} transparent animationType="none" statusBarTranslucent>
      <View style={{ flex: 1, backgroundColor: 'rgba(15,23,42,0.55)' }}>
        ...
        <GestureDetector gesture={panGesture}>
          <Animated.View style={[{ backgroundColor: '#fff', borderTopLeftRadius: 32, borderTopRightRadius: 32, paddingBottom: insets.bottom + 24, maxHeight: '90%' }, useAnimatedStyle(() => ({ transform: [{ translateY: translateY.value }] }))]}>
...
export default function MissionControlScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#FDFCFB]" edges={['top']}>
      ...
      <ApprovalCardModal visible={isApprovalModalOpen} onClose={() => setIsApprovalModalOpen(false)} pendingApprovals={pendingApprovals} onApprove={(id: string) => approveChore(id)} onReject={(id: string, r: string) => rejectChore(id, r)} />
