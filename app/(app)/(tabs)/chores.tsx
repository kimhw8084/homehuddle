...
export default function ChoresView() {
  ...
  const handleCompleteChore = useCallback((id: string) => {
    ...
    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
  }, [chores, updateChore, addChore, currentUser, familyMembers, setPtsNotify]);
  ...
  }, [chores, currentUser, updateChore, familyMembers, setPtsNotify]);
  ...
  const handleCompleteOnBehalf = useCallback((id: string) => {
    ...
    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
  }, [chores, currentUser, updateChore, addChore, familyMembers, setPtsNotify]);
      ...
      <SafeAreaView className="flex-1 bg-slate-50 dark:bg-black" edges={['top']}>
        ...
        {isAddingChore && (
          <QuickAddChorePanel
            ...
            onAdd={(c) => {
              addChore({ ...c, sectionId: c.sectionId ?? null, due: c.dueDate });
        ...
        {editingChore && (
          <ChoreEditPanel
            ...
            onSave={(id, updates) => { 
              // Convert to our internal handleEditChore format if needed, or update store directly
