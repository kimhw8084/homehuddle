...
import { ChevronLeft, Bell, MessageSquare, Zap, Clock } from 'lucide-react-native';
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.list}>
          ...
          <NotificationRow 
            ...
            onToggle={() => toggleSetting('points')}
          />
          <NotificationRow 
            label="Daily Reminders" 
            description="Get a morning summary of your daily chores"
            icon={Clock}
